...
![](/img/data_manus/1.png)

**2.点击右侧”添加数据源“，在弹出的表单中配置自己的数据源信息**

![](/img/data_manus/2.png)
